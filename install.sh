...
installTheme(){
    ...
    rm /var/www/pterodactyl/resources/scripts/Pterodactyl_NinjaMC_Theme.css > /dev/null 2>&1
    ...
    mv Pterodactyl_Nightcore_Theme.css /var/www/pterodactyl/resources/scripts/Pterodactyl_NinjaMC_Theme.css > /dev/null 2>&1
    cd /var/www/pterodactyl > /dev/null 2>&1
...
repair(){
    bash <(curl https://raw.githubusercontent.com/Leo-Galli/Pterodactyl_NinjaMC_Theme/main/repair.sh)
}

restoreBackUp(){
    echo "Restoring backup..."
    cd /var/www/ > /dev/null 2>&1
    tar -xvf Pterodactyl_NinjaMC_Themebackup.tar.gz > /dev/null 2>&1
...
echo "Copyright (c) 2025 LeoGalli"
